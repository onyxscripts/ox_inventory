...
shared = {
    ...
    networkdumpsters = string.lower(GetConvar('inventory:networkdumpsters', 'false')) == 'true' or GetConvarInt('inventory:networkdumpsters', 0) == 1
}
...
if IsDuplicityVersion() then
    server = {
        ...
        randomloot = string.lower(GetConvar('inventory:randomloot', 'true')) == 'true' or GetConvarInt('inventory:randomloot', 1) == 1,
